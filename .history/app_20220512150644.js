...
var handlebars = expHbs.create({
    ...
    helpers: {generateTime: generateTime, select:select, paginate:paginate},
    extname: '.handlebars',
});
...
app.use((req, res, next)=>{
    res.locals.user = req.user||null;  //Nguoi dung da dang nhap - globl user
...
const comments = require('./routers/admin/comments.js');
