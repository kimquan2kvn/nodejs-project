...
router.post('/register', (req, res)=>{
    ...
    if(!req.body.password){
        errors.push({message: 'Hãy nhậ password'});
    }
...
router.get('/post/:id', (req, res)=>{
    Post.findOne({_id:req.params.id}).lean().populate({path: 'comment', match: {approveComment: true}, populate: {path: 'user', model: 'users'}}).populate('user').then(post=>{
        Category.find({}).lean().then(categories=>{
